...
{
       2,     3,     0,     3,     4,     0,     8,     5,     0,     5,
       0,    15,    16,    17,    18,    10,    11,    12,    13,     0,
      14,     9,    10,    11,    12,    13,    12,    13
};
...
#line 36 "calculator.y"
              { printf("Result: %.2f\n> ", (yyvsp[-1].fval)); }
#line 1077 "calculator.tab.c"
    break;

  case 6: /* exp: NUMBER  */
#line 39 "calculator.y"
                    { (yyval.fval) = (yyvsp[0].fval); }
#line 1083 "calculator.tab.c"
    break;

  case 7: /* exp: exp '+' exp  */
#line 40 "calculator.y"
                    { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1089 "calculator.tab.c"
    break;

  case 8: /* exp: exp '-' exp  */
#line 41 "calculator.y"
                    { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1095 "calculator.tab.c"
    break;

  case 9: /* exp: exp '*' exp  */
#line 42 "calculator.y"
                    { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1101 "calculator.tab.c"
    break;
...
#line 1114 "calculator.tab.c"
    break;

  case 11: /* exp: '(' exp ')'  */
#line 51 "calculator.y"
                    { (yyval.fval) = (yyvsp[-1].fval); }
#line 1120 "calculator.tab.c"
    break;


#line 1124 "calculator.tab.c"
